...
class TestCNN(object):
  ...
  def iterate_minibatches(self, inputs, targets, batchsize, shuffle=False):
      ...
      for start_idx in range(0, len(inputs['image']) - batchsize + 1, batchsize):
          ...
          yield inputs['image'][excerpt], inputs['prob'][excerpt], inputs['binary1'][excerpt], inputs['binary2'][excerpt], inputs['overlap'][excerpt], inputs['bbox'][excerpt], inputs['border'][excerpt], targets[excerpt]
