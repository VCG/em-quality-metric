...
class TrainCNN(object):
  ...
  def __init__(self):
    ...
    self._MOMENTUM = 0.9
    self._INPUT_SHAPE = (None, 4, self._patch_size[0], self._patch_size[1])#(None, 75, 75)#(None, 1, 75, 75)
    self._NO_FILTERS = 32
  ...
  def load_dataset(self):
      ...
      #
      training = {
        'image': training['image'].astype(np.double)/255).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'prob': training['prob'].astype(np.double)/255).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'binary': training['binary'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'label1': training['label1'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'label2': training['label2'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'merged_array': training['merged_array'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_obj': training['dyn_obj'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_bnd': training['dyn_bnd'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_bnd_dyn_obj': training['dyn_bnd_dyn_obj'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'border_overlap': training['border_overlap'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'larger_border_overlap': training[larger_border_overlap_label].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1])
      }
      ...
      #
      val = {
        'image': val['image'].astype(np.double)/255).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'prob': val['prob'].astype(np.double)/255).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'binary': val['binary'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'label1': val['label1'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'label2': val['label2'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'merged_array': val['merged_array'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_obj': val['dyn_obj'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_bnd': val['dyn_bnd'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_bnd_dyn_obj': val['dyn_bnd_dyn_obj'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'border_overlap': val['border_overlap'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'larger_border_overlap': val[larger_border_overlap_label].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1])
      }
      ...
      #
      test = {
        'image': test['image'].astype(np.double)/255).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'prob': test['prob'].astype(np.double)/255).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'binary': test['binary'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'label1': test['label1'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'label2': test['label2'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'merged_array': test['merged_array'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_obj': test['dyn_obj'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_bnd': test['dyn_bnd'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'dyn_bnd_dyn_obj': test['dyn_bnd_dyn_obj'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'border_overlap': test['border_overlap'].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1]),
        'larger_border_overlap': test[larger_border_overlap_label].astype(np.uint8).reshape(-1, 1, self._patch_size[0], self._patch_size[1])
      }
