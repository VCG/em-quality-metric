...
class LogisticRegression(object):
    ...
    # FIXME hopefully obsolete now that I understand theano better 
    # def get_p_y_given_x(self, input=None):
    #     if input is None:
    #         return T.nnet.softmax(T.dot(self.input, self.W) + self.b)
    #     else:
    #         return T.nnet.softmax(T.dot(input, self.W) + self.b)

    # def get_classification(self, input):
    #     p_y_given_x = self.get_p_y_given_x(input)
