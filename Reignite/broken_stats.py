...
class Stats(object):
  ...
  def create(cnn_name, patch_path, inputs, trained_gt=True):
    ...
    for data in ['gt','rhoana']:
        ...
        with open(REAL_OUTPUT_PATH+os.sep+'splits_'+data+'_results.p', 'rb') as f:
            p = pickle.load(f)

        global_vi_diffs = p['global_vi_diffs']
    ...
    'MERGES_GT_TOP4':0,
    'MERGES_GT_TOP5':0,
    'MERGES_RHOANA_TOP1':0,
    'MERGES_RHOANA_TOP2':0,
    'MERGES_RHOANA_TOP3':0,
    'MERGES_RHOANA_TOP4':0,
    'MERGES_RHOANA_TOP5':0
    }
