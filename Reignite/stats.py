...
class Stats(object):
  ...
  def create(cnn_name, patch_path, inputs, trained_gt=True):
    ...
    TEST_ACC = 0.99
    CONFIGURATION = 'dfdsf'
    SLICES = [70]#[70,72]#[70,71,72,73,74]
    SPLIT_BBOX = [200,500,200,500]#[0,1024,0,1024]#[200,500,200,500]
    MERGE_BBOX = [200,700,200,700]#[0,1024,0,1024]#[200,700,200,700]#[0,1024,0,1024]
    MERGE_N = 5
    MERGE_ITERATIONS = 1
