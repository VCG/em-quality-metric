...
def generate_experiment_data_supervised(makeItShort=False, purpose='train', nsamples=1000, patchSize=29, balanceRate=0.5, data_mean=0.0, data_std=1.0, grayImages=None, labelImages=None, maskImages=None, outfile = 'isbiData.pkl.gz', saveData=False):
    ...
    #pathPrefix = '/media/vkaynig/Data1/Synapses/'
    #img_search_string_membraneImages = pathPrefix + 'labels/positive/' + purpose + '/*.tif'
    #img_search_string_backgroundMaskImages = pathPrefix + 'labels/negative/' + purpose + '/*.tif'
...
#        mask_img = np.logical_and(mask_img, mask_dark)
        ...
        for i in xrange(nsamples_perImage):
            ...
            #positiveSample = np.random.random() < balanceRate
...
def generate_experiment_data_supervised_parallel(purpose='train', nsamples=1000, patchSize=29, outfile = 'isbiData.pkl.gz', saveData=False, balanceRate=0.5, data_mean=0.0, data_std=1.0, grayImages=None, labelImages=None, maskImages=None, nrProcesses=4):
